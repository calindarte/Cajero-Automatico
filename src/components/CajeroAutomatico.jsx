...
const  CajeroAutomatico = () =>{
  ...
  return (
    <div className=" md:border-[30px] border-[20px] md:p-20 px-8 py-14  border-x-slate-900   bg-amber-500 " >
        
      <div className="flex flex-col border-solid border-[15px] md:border-[40px] border-y-slate-600 bg-blue-200  shadow-lg items-center md:p-6 px-4 py-12 md:gap-6 gap-8 rounded-xl">


        <div className="flex justify-between items-center md:px-8 ">
        <img src={logoCajero} alt="" className="object-fill w-[10%] h-auto" />
          <h1 className="font-bold text-center  font-serif md:text-4xl text-lg ">Cajero Automático</h1>
        <img src={logoDinero} alt="" className="object-fill w-[10%] h-auto" />
        </div>
        <form onSubmit={handleSubmit} className="flex flex-col md:gap-8 gap-14">
          ...
          <ul className="md:text-lg flex flex-col md:gap-8 gap-16  ">
            {billetes.map((billete, index) => (
              <li key={index} className="flex  gap-5 flex-wrap">
          ...
          <div className="flex flex-col md:flex-row md:gap-3 gap-9  justify-center  ">
            <button
              type="submit"
